...
export const VARIANTS: LabVariantMeta[] = [
  ...
  { slug: "motion-spring", name: "Motion · Spring", vibe: "the original — fade-up stagger, springy hover lifts, pulse ring", swatch: ["#09090b", "#18181b", "#8b5cf6", "#a1a1aa"] },
  { slug: "motion-cascade", name: "Motion · Cascade", vibe: "slides in from the left, edge-lit hovers, segmented bars", swatch: ["#09090b", "#18181b", "#6366f1", "#a1a1aa"] },
